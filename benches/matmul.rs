...
use annapura::{matmul_ikj, matmul_naive};
...
fn bench_matmul_naive(c: &mut Criterion) {
    ...
    for &n in &[64usize, 128, 256, 512] {
        ...
        // 2·n³ FLOPs per call; criterion reports as "elem/s" — read as FLOP/s.
...
criterion_group!(benches, bench_matmul_naive, bench_matmul_ikj);
